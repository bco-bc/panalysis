...
def usage():
    ...
    print('-spec_1 NAME: NAME is one of two particle specification names.')
    print('-spec_2 NAME: NAME is one of two particle specification names.')
    print()
...
if __name__ == '__main__':
    ...
    analyzer = Gr(bin_size=0.01, box=particle_system.box, r_max=r_max, spec_1=spec_1, spec_2=spec_2)
