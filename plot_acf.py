...
auto util function (ACF), and generates a plot. Input file should contain 2 or more columns of data. The first
...
import sys
import numpy as np
import util.acf as corr
import matplotlib.pyplot as plt

if len(sys.argv) < 2:
    print('Number of arguments: ', len(sys.argv))
    print('Argument List: ', str(sys.argv))
    print('Usage: python3 plot_acf.py <filename> <n_use>')
...
results = corr.calculate(data, n_use)
time = results[0]
